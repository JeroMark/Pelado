...
import Exeption.BusquedaExeption;
import Exeption.LogginExeption;
import Exeption.ReservaExeption;
import Exeption.SinPermisoExeption;
import Model.*;
import Enum.*;
...
public class Controlador {
    ...
    public void registrarGerente(int dni, String nombre, String apellido, String telefono, String mail, TipoContacto contacto,String contrasenia){
        Gerente user=new Gerente(dni,nombre,apellido,telefono,mail,contacto,contrasenia);
        gerentes.add(user);
    }
    public void registrarCliente(int dni, String nombre, String apellido, String telefono, String mail, TipoContacto contacto,String contrasenia){
    ...
    public void crearReserva(ArrayList<Integer> idHabitacion, Date checkIn, Date checkOut, int idCliente, MedioDePago medioDePago){
